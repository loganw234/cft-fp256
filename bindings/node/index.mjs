...
export {
  ABI_MAJOR, ALU_EXT_IMUL, AUGMENTED, CHARACTER_FNS, CLASS_NAMES, FEAT_REDUCE_SEG,
  FLAGS_ALL, FLAG_DIVBYZERO,
  ...
  SCALED_PRODUCTS,
  SEQ_FEATURE_NAMES, SEQ_FEAT_BANK_PTR, SEQ_FEAT_INDEXED, SEQ_FEAT_KX9,
  SEQ_FEAT_LANE_MASK, SEQ_FEAT_REGS32, SEQ_FEAT_SCALAR,
  SEQ_FEAT_SCRATCH, SEQ_FEAT_SCRATCH_IO, SEQ_FEAT_SCRATCH_STRICT,
