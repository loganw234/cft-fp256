 ...
 *  atan2 expects. Nothing in this package reorders them. */
...
async function instantiate() {
  ...
  // name lists.
  //
  // The argument list ends at the flag word for all twenty. That is
  // the contract's shape, not an oversight: these issue no device
  // pass, so there is no bus word (cft.h). Sixteen are unary; pow,
  // hypot, atan2 and atan2pi take b.
