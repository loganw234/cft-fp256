...
| document | lines | what it is for |
|---|---|---|
| [HOSTAPI.md](HOSTAPI.md) | 2,545 | The host API, function by function. The largest reference here and the one most often wanted. |
...
| document | lines | what it is for |
|---|---|---|
| [VALIDATION.md](VALIDATION.md) | 12,563 | The validation ledger, append-only. Every run, including the ones that failed and the mistakes that produced them. A figure here is a fact about the run on its date and is never edited to match a later one. |
| [ROADMAP.md](ROADMAP.md) | 2,959 | What is built, what is next, and what was decided against. |
