...
Thirty-five files, 41,170 lines. Flat in one directory they look like one
...
- **1,499 lines of operations**, read when you are about to do something to
  hardware;
- **19,214 lines of record and argument** — the ledger, the roadmap and the
...
| document | lines | what it is for |
|---|---|---|
| [HOSTAPI.md](HOSTAPI.md) | 2,314 | The host API, function by function. The largest reference here and the one most often wanted. |
...
| document | lines | what it is for |
|---|---|---|
| [VALIDATION.md](VALIDATION.md) | 11,403 | The validation ledger, append-only. Every run, including the ones that failed and the mistakes that produced them. A figure here is a fact about the run on its date and is never edited to match a later one. |
| [ROADMAP.md](ROADMAP.md) | 2,851 | What is built, what is next, and what was decided against. |
...
| [SITES.md](SITES.md) | 300 | The four format sites - binary32.com, binary64.com, binary128.com, binary256.com: one template, four fillings, what each site carries, how the project appears on a page that is not about it, and how four custom domains are served from GitHub Pages. A plan, nothing built. |
