...
Thirty-seven files, 49,311 lines. Flat in one directory they look like one
...
- **1,761 lines of operations**, read when you are about to do something to
  hardware;
- **25,414 lines of record and argument** — the ledger, the roadmap and the
...
| [VERIFICATION.md](VERIFICATION.md) | 379 | Every gate, what it proves, how long it really takes. Twelve tiers, forty runner stages. |
...
| document | lines | what it is for |
|---|---|---|
| [VALIDATION.md](VALIDATION.md) | 14,563 | The validation ledger, append-only. Every run, including the ones that failed and the mistakes that produced them. A figure here is a fact about the run on its date and is never edited to match a later one. |
