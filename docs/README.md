...
| [SEQUENCER.md](SEQUENCER.md) | 1,775 | The orbit sequencer and the program model. |
...
| [ROUND2.md](ROUND2.md) | 1026 | The plan for the gather, the scatter, the lane mask and the broadcast as one parcel round: the seam the lead lands first, a brief per parcel, the verifiers, the ledger, the merge order. |
