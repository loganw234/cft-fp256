...
Thirty-five files, 43,597 lines. Flat in one directory they look like one
...
- **1,539 lines of operations**, read when you are about to do something to
  hardware;
- **20,921 lines of record and argument** — the ledger, the roadmap and the
...
| [ROUND2.md](ROUND2.md) | 882 | The plan for the gather, the scatter, the lane mask and the broadcast as one parcel round: the seam the lead lands first, a brief per parcel, the verifiers, the ledger, the merge order. |
