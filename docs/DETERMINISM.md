...
correctly rounded. Clause 5's last requirement, 5.12's conversions
...
`python/cft_golden/softfloat.py` defines the bits, with
`python/cft_golden/chars.py` for the character conversions.
