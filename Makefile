...
help:
	...
	@echo "docs-check   prove docs/README.md indexes every document, that every"
	@echo "             document's links and quoted paths resolve, and that the"
	@echo "             counts it checks are true (planted-fault controls)"
