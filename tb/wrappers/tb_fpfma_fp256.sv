...
// cocotb top: fp256 instantiation of the FMA pipe. MUL_PASSES paces the
...
module tb_fpfma_fp256 #(
  ...
  localparam int NP  = cft_mul_passes(236 + 1, MUL_PASSES);
  ...
  cft_fpfma_pipe #(.EXP_W(19), .MAN_W(236), .LATENCY(16),
