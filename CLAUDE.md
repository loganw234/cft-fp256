...
```
make verify-quick            # ~20 min, 25 of 38 stages
make verify-gate             # ~2 h quiet, 33 of 38 - what a change should pass
...
**`make sim` now gates (fixed 2026-09-12).** It runs its twenty-three
